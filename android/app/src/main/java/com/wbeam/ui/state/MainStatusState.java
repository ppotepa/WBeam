...
public final class MainStatusState {
    ...
    public String getUiState() { return uiState; }
    public void setUiState(String uiState) { this.uiState = uiState; }
    public String getUiInfo() { return uiInfo; }
    public void setUiInfo(String uiInfo) { this.uiInfo = uiInfo; }
    public long getUiBps() { return uiBps; }
    public void setUiBps(long uiBps) { this.uiBps = uiBps; }
    public String getCriticalErrorInfo() { return criticalErrorInfo; }
    public void setCriticalErrorInfo(String criticalErrorInfo) { this.criticalErrorInfo = criticalErrorInfo; }
    public long getCriticalErrorLogAtMs() { return criticalErrorLogAtMs; }
    public void setCriticalErrorLogAtMs(long criticalErrorLogAtMs) { this.criticalErrorLogAtMs = criticalErrorLogAtMs; }
