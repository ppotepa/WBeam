...
public final class RuntimeHudShellRenderer {
    ...
    public static String buildHtml(
        ...
        return "<!doctype html><html><head><meta charset='utf-8'/>"
                ...
                + "</div>"
                + "<div class='main'>"
                + "<div class='panel panel-main'><div class='kpi'>" + cardsHtml + "</div><div class='metric-trends'>" + chartsHtml + "</div><div class='trend'>" + HudRenderSupport.escapeHtml(HudRenderSupport.safeText(trendText)) + "</div><div class='resource'><div class='title'>DEVICE RESOURCES (* GPU proxy from render time)</div>" + resourceRowsHtml + "</div></div>"
